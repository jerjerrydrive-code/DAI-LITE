...
import com.dai.flipper.data.ModelInfo
import com.dai.flipper.data.OpenRouterModelCatalog
...
data class SettingsState(
    ...
    val defaultProjectPath: String = "/ext/apps_data/dai",
...
class SettingsViewModel @Inject constructor(
    ...
    private val _apiBaseUrl = MutableStateFlow(SettingsStore.DEFAULT_BASE_URL)
    ...
    init {
        ...
        viewModelScope.launch {
            settingsStore.apiBaseUrl.collect { _apiBaseUrl.value = it }
        }
    }
