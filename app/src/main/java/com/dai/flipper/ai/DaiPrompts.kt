...
/**
 * Centralized AI Prompt System for Dai
 *
...
object DaiPrompts {
    ...
    // ============================================================
    // CORE DAI SYSTEM PROMPT
    // ============================================================

    val SYSTEM_PROMPT = """
You are Dai, an elite AI agent that controls a Flipper Zero device through a structured command interface. You operate on Android via Bluetooth Low Energy.
