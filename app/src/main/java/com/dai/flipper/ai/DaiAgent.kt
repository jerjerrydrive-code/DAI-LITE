...
import com.dai.flipper.data.database.ChatMessageEntity
import com.dai.flipper.domain.executor.CommandExecutor
import com.dai.flipper.domain.model.*
import com.dai.flipper.domain.model.ToolResult as ChatToolResult
 ...
 * Implemented by [GlassesIntegration] and registered via [DaiAgent.setPhotoCaptureCallback].
 */
 ...
 */
@Singleton
class DaiAgent @Inject constructor(
