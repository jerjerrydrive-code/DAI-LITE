...
import com.dai.flipper.MainActivity
import com.dai.flipper.R
import com.dai.flipper.DaiApplication
...
class FlipperBleService : Service() {
    ...
    private fun createNotification(): Notification {
        ...
        return NotificationCompat.Builder(this, DaiApplication.CHANNEL_BLE)
    ...
    companion object {
        ...
        const val ACTION_START_FOREGROUND = "com.dai.flipper.START_FOREGROUND"
        const val ACTION_STOP = "com.dai.flipper.STOP"
        const val ACTION_USB_PERMISSION = "com.dai.flipper.USB_PERMISSION"
